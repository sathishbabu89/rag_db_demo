...
st.title("📚 RAG Chatbot with SQLite + ChromaDB")

# Upload PDF or add manual document
...
# Track added document IDs to avoid duplicates
...
# -------------------------------
# 7. Chat input and response
# -------------------------------
user_query = st.chat_input("Ask me something about your documents...")

if user_query:
    try:
        # Retrieve top 2 relevant documents from ChromaDB
